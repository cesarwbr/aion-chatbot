  ...
  rl.on('line', function(line) {
    switch (line) {
      ...
      case "print match":
        ...
        console.log("Input humanized: ".green+inputHzd.blue);
        console.log("Pattern: ".green+match.pattern.blue);
        console.log("Humour : ".green+humour.blue);
        console.log("Answer : ".green+answer.blue);
        break;
